...
{% include atuacao-profissional.md %}
...
{% include experiencia-profissional.md %}

<!-- incluindo quebra de página de impressão -->
<div class="page-break"></div>
<div class="only-print"><br/><br/></div>

<!-- incluindo projetos para impressao -->
<div class="only-print" markdown="1">
{% include_relative projetos.md %}
</div>
...
{% include aprovacoes-concursos.md %}
